                ...
                <div class="card-body">
                    ...
                    <form>
                        ...
                        <div class="row">   
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="cust_email" name="cust_email" value="<?php echo e($rfqupdate->piccust_email); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">   
                        ...
                        <div class="float-end">
                            ...
                            <a href="<?php echo e(route('proposal-list')); ?>" class="btn btn-danger">Cancel</a>
                        </div>
                    </form>
                </div>
                <!-- end card body -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/crm_boilermaster/resources/views/edit-proposal.blade.php ENDPATH**/ ?>