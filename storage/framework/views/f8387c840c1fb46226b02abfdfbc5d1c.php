                ...
                <table id="datatable" class="table table-striped dataTable no-footer nowrap w-100">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                    <a href="senarai-docs/<?php echo e($m->id); ?>" ><i class="bx bx-folder" style="color:black" title="View File"></i></a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\crm\resources\views/proposal-list.blade.php ENDPATH**/ ?>