        ...
        <div class="card">
            <div class="card-body">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create-company')): ?>
                    <a href="<?php echo e(route('companies.create')); ?>" class="btn btn-primary"> <i class="bx bx-plus"></i> Create</a>
                <?php endif; ?>
                </h3>
                ...
                <table id="datatable" class="table table-striped dataTable no-footer nowrap w-100">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <?php else: ?>
                            <?php $__currentLoopData = $companyList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <td><?php echo e($i++); ?></td>
                            <td><?php echo e($m->company_name); ?></td>
                            <td><?php echo e($m->address); ?></td>
                            <td><?php echo e($m->phone); ?></td>
                            <td>
                                <a href="<?php echo e(route('companies.show',$m->id)); ?>"><i class="bx bx-search-alt" title="View Details Companies" style="color:black"></i></a>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-company')): ?>
                                    <a href="<?php echo e(route('companies.edit',$m->id)); ?>"><i class="bx bx-edit-alt" title="Edit/Update Companies"></i></a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-company')): ?>
                                    <?php echo Form::open(['method' => 'DELETE','route' => ['companies.destroy', $m->id],'style'=>'display:inline']); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\boilermaster\resources\views/companies/index.blade.php ENDPATH**/ ?>