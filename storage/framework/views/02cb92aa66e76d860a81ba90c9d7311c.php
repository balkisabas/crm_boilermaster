                ...
                <div class="card-body">
                    ...
                    <table id="datatable" class="table table-striped dataTable no-footer nowrap w-100">
                        ...
                        <tr>
                            ...
                            <?php if($m->activation_status == 'Yes'): ?>
                                <td><span class="badge bg-success fs-6"><?php echo e($m->activation_status); ?></span></td>
                            <?php else: ?>
                                <td><span class="badge bg-danger fs-6"><?php echo e($m->activation_status); ?></span></td>
                            <?php endif; ?>
                            <td>
                                <a href="<?php echo e(route('editUser', $m->id)); ?>" ><i class="bx bx-edit-alt" title="Edit"></i></a>
                                <a href="<?php echo e(route('deleteUser', $m->id)); ?>"><i class="bx bx-trash"  onclick="return confirm('Delete this record?')" title="Delete"></i></a>
                            </td>
                        </tr>    
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\crm_boilermaster\resources\views/user-list.blade.php ENDPATH**/ ?>