                            ...
                            <form action="<?php echo e(route('branches.store')); ?>" method="POST" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                                <div class="row">                                            
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <input type="hidden" class="form-control" id="parent_id" name="parent_id" placeholder="Enter your name" value="<?php echo e($data['id']); ?>"  >
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\boilermaster\resources\views/branches/create.blade.php ENDPATH**/ ?>