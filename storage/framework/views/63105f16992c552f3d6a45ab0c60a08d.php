...
<?php $__env->startSection('title', 'List of RFQ Status'); ?> 
        ...
        <div class="card">
            <div class="card-body">
                ...
                <h3 class="card-title mb-4 d-flex justify-content-between align-items-center">List of  RFQ Status
                    <a href="<?php echo e(route('rfqstatus.create')); ?>" class="btn btn-primary"> <i class="bx bx-plus"></i> Create</a>
                </h3>
                ...
                <table id="datatable" class="table table-striped dataTable no-footer nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <?php
                            $i = 1;
                            ?>
                            <?php if(count($rfqstatus) === 0): ?>
                            <td colspan="10" align="center">No records found.</td>  
                            <?php else: ?>
                            <?php $__currentLoopData = $rfqstatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <td><?php echo e($i++); ?></td>
                            <td><?php echo e($m->name); ?></td>
                            <td>
                                <a href="<?php echo e(route('rfqstatus.show',$m->id)); ?>"><i class="bx bx-search-alt" title="View Details RFQ Status" style="color:black"></i></a>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-proposalstatus')): ?>
                                    <a href="<?php echo e(route('rfqstatus.edit',$m->id)); ?>"><i class="bx bx-edit-alt" title="Edit/Update RFQ Status"></i></a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-proposalstatus')): ?>
                                    <?php echo Form::open(['method' => 'DELETE','route' => ['rfqstatus.destroy', $m->id],'style'=>'display:inline']); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\boilermaster\resources\views/rfqstatus/index.blade.php ENDPATH**/ ?>