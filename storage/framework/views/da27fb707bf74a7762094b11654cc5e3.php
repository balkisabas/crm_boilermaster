...
<!-- end page title -->
<form action="<?php echo e(route('daftarUser')); ?>" method="POST" class="form-horizontal"   enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\crm_boilermaster\resources\views/new-user.blade.php ENDPATH**/ ?>