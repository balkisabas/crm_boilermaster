...
<?php $__env->startSection('title', 'List of Position'); ?> 
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">List of Position</h4>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h3 class="card-title mb-4 d-flex justify-content-between align-items-center">List of Position
                    <a href="<?php echo e(route('positions.create')); ?>" class="btn btn-primary"> <i class="bx bx-plus"></i> Create</a>
                </h3>
                ...
                <table id="datatable" class="table table-striped dataTable no-footer nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            <td>
                                <a href="<?php echo e(route('positions.show',$m->id)); ?>"><i class="bx bx-search-alt" title="View position" style="color:black"></i></a>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-position')): ?>
                                    <a href="<?php echo e(route('positions.edit',$m->id)); ?>"><i class="bx bx-edit-alt" title="Edit/Update position"></i></a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-position')): ?>
                                    <?php echo Form::open(['method' => 'DELETE','route' => ['positions.destroy', $m->id],'style'=>'display:inline']); ?>

                                    <a href="#" onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this position?')) { this.parentNode.submit(); }" >
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\boilermaster\resources\views/positions/index.blade.php ENDPATH**/ ?>