...
<?php $__env->startSection('title', 'Customer Listing'); ?> 
            ...
            <div class="card">
                <div class="card-body">
                    <h3 class="card-title mb-4 d-flex justify-content-between align-items-center text-capitalize"><?php echo e($page_modual); ?> List
                        <a href="<?php echo e(route('customers.create')); ?>"class="btn btn-primary"> <i class="bx bx-plus"></i> Create </a>
                    </h3> 
                            ...
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr  class="table-active">
                                        ...
                                        <td align="center">
                                            ...
                                            ?>
                                            <a href="<?php echo e(route('customers.show',$value)); ?>" ><i class="bx bx-search" title="Search"></i></a>
                                            <a href="<?php echo e(route('customers.edit',$value)); ?>"><i class="bx bx-edit-alt" title="Edit"></i></a>
                                            <?php echo Form::open(['method' => 'DELETE','route' => ['customers.destroy', $d->id],'style'=>'display:inline']); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\boilermaster\resources\views/customers/index.blade.php ENDPATH**/ ?>