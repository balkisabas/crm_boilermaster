        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="/index" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{ URL::asset ('/build/images/logo.PNG') }}" alt="" height="55" width="130">
                    </span>
                </a>
    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <!-- item-->
                <a class="dropdown-item" href="{{route('users.show', (Auth::user()->id)) }}"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile">@lang('translation.Profile')</span></a>
