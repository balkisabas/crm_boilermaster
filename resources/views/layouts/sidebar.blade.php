    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li><a href="{{route('documents.index')}}"><i class="bx bxs-folder"></i><span key="t-layouts">Document Type</span></a></li>
                <li><a href="{{route('positions.index')}}"><i class="fa fa-user-circle"></i><span key="t-layouts">Position</span></a> </li>
                <li><a href="{{route('roles.index')}}"><i class="fa fa-user-secret"></i><span key="t-layouts">Role</span></a> </li>
                <li><a href="{{route('rfqtypes.index')}}"><i class="fa fa-file"></i><span key="t-layouts">RFQ Type</span></a>
                </li><li><a href="{{route('rfqstatus.index')}}"><i class="bx bx-list-check"></i><span key="t-layouts">RFQ Status</span></a></li>
                <li><a href="{{route('users.index')}}"><i class="fa fa-users"></i><span key="t-layouts"> User</span> </a></li>
                <li><a href="{{route('audits.index')}}"><i class="bx bxs-file"></i><span key="t-layouts">Audit Trail</span> </a></li>
            </ul>
        </div>
        <!-- Sidebar -->
    </div>
