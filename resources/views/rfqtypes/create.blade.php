...
<!-- end page title -->
<form action="{{ route('rfqtypes.store') }}" method="POST" class="form-horizontal"  enctype="multipart/form-data">
    @csrf
    @if (session('status'))
            ...
            <div class="card">
                <div class="card-body">
                    <h3 class="card-title mb-4 d-flex justify-content-between align-items-center">Create RFQ Type
                        <a class="btn btn-primary" href="{{ route('rfqtypes.index') }}"><i class="bx bx-arrow-back"></i> Back</a>
                    </h3>
                    <form>
                        <div class="row">                                            
                            <div class="col-md-12">
