                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="reg_no" name="reg_no" value="{{ $customer['reg_no']}}" placeholder="Enter your registration number" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea id="web_url" name="web_url" cols="30" rows="1" class="form-control"   placeholder="Enter your website URL" >{{ $customer['web_url']}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="to" class="form-label">Fax Number  </label>
                                            <input type="number" class="form-control" id="fax_no" name="fax_no" value="{{ $customer['fax_no']}}" placeholder="Enter your fax number"  >
                                        </div>
                                    </div>
                                </div> 
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            @foreach ($picUser as $p)
                                                <option value="{{$p->name}}" {{$p->name == $customer->pic? 'selected':''}}>{{$p->name}}</option>
                                            @endforeach
                                            </select>
                                        </div>
                                    </div> 
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="email" name="email" cols="30" rows="1" class="form-control" value="{{ $customer['email']}}"placeholder="Enter email" required>
                                        </div>
                                    </div> 
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="bank_name" name="bank_name" value="{{ $customer['bank_name']}}" placeholder="Enter Bank Name">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="title" class="form-label">Customer Account Number  </label>
                                            <input type="number" id="bank_acc_no" name="bank_acc_no" cols="30" rows="1" value="{{ $customer['bank_acc_no']}}" class="form-control" placeholder="Enter Acc no"  >
                                        </div>
                                    </div> 
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="swift_code" name="swift_code" value="{{ $customer['swift_code']}}" placeholder="Enter your swift code">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="to" class="form-label">Status {{$customer['status']}}<span style="color:red">*</span></label>
                                            <select   id="active" name="active" class="form-control" >
                                            <option value="Active" {{ $customer['status'] == 'Active' ? 'selected' : '' }}>Active</option>
                                            <option value="Inctive" {{ $customer['status'] != 'Active' ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                @else
                                    ...
                                    @foreach ( $personic as $m)
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            @if ( $count  > 1)
                                                <div class="col-sm-1">
                                                    <a href=  "{{ route('delete_pic_'.$page_modual, ['id' => $m->id, 'page_modual' => $page_modual, 'parent_id' => $customer['id'] ]) }}" onclick="return confirm('Are you sure you want to delete  ?')" class="btn btn-warning w-md  col-sm-1 removeTextField" style="margin-top: 27px;"> Remove </a> 
                                                </div>
                                            @else
                                                <div class="col-sm-1">
                                                    <button type="button" name="tmb" id="addTextField" class="btn btn-success w-md" style="margin-top: 27px;">Add</button>
