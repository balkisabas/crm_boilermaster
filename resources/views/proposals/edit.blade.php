                    ...
                    <div class="row">   
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="final_pricing" name="final_pricing" value="{{$proposal->final_pricing}}" placeholder="Enter price (e.g., 0.00)">
                            </div>
                        </div>
                    </div>
                    <div class="row">   
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="award_amount" name="award_amount" value="{{$proposal->award_amount}}" placeholder="Enter award amount">
                            </div>  
                        </div> 
                    </div>
                    <hr style="  border: none;  height: 1px; background-color: black;">
