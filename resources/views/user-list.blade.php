                ...
                <div class="card-body">
                    ...
                    <table id="datatable" class="table table-striped dataTable no-footer nowrap w-100">
                        ...
                        <tr>
                            ...
                            @endif
                            <td>
                                <a href="{{ route('editUser', $m->id)}}" ><i class="bx bx-edit-alt" title="Edit"></i></a>
                                <a href="{{ route('deleteUser', $m->id)}}"><i class="bx bx-trash"  onclick="return confirm('Delete this record?')" title="Delete"></i></a>
                            </td>
                        </tr>    
                        @endforeach
                        @endif
