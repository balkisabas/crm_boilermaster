                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="fax_no" name="fax_no" value="{{ $branch['fax_no']}}" placeholder="Enter your fax number" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="to" class="form-label">Status <span style="color:red">*</span></label>
                                             ...
                                             <option value="2" {{ $branch['active'] != '1' ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                        </div>
                                    </div>
