            ...
            <div class="card">
                <div class="card-body">
                    <h3 class="card-title mb-4 d-flex justify-content-between align-items-center text-capitalize">{{$page_modual}} List 
                        <a href="{{ route('vendors.create') }}"class="btn btn-primary"> <i class="bx bx-plus"></i> Create </a>
                    </h3> 
                            ...
                            @foreach ($data as $d)
                                    ...
                                    <tr  class="table-active">
                                        ...
                                        <td align="center">
                                            ...
                                            @endphp
                                            <a href="{{ route('vendors.show',$value) }}" ><i class="bx bx-search" title="Search"></i></a>
                                            <a href="{{ route('vendors.edit',$value)  }}"><i class="bx bx-edit-alt" title="Edit"></i></a>
                                            {!! Form::open(['method' => 'DELETE','route' => ['vendors.destroy', $d->id],'style'=>'display:inline']) !!}
